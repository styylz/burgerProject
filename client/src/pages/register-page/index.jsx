...
const Register = () => (
  ...
  >
    ...
    >
      ...
      <Box sx={{ mb: 5 }}>
        <TextField fullWidth label="Name" variant="standard" sx={{ marginBottom: '10px', color: yellowCol }} />
        <TextField fullWidth label="E-mail" variant="standard" sx={{ marginBottom: '10px', color: yellowCol }} />
        <TextField fullWidth label="Password" variant="standard" sx={{ marginBottom: '10px', color: yellowCol }} />
        <TextField fullWidth label="Repeat Password" variant="standard" />
